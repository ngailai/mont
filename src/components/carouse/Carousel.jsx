...
import hero1 from '../../../public/assets/hero/mt25.jpg';
import hero2 from '../../../public/assets/hero/hero3.jpg';
import hero3 from '../../../public/assets/hero/mt23.jpg';
        ...
        <main className='relative flex h-[calc(100vh-70px)] w-screen items-center justify-center '>
            <div className='absolute w-full h-full'>
                ...
                <div className='absolute bottom-8 left-10 py-3 px-6 bg-[#0000007c] text-white rounded-lg'>
                    ...
                    <p className='text-2xl text-purple-500 mt-4'>
            ...
            >
                <span className='inline-block transition-transform hover:-translate-x-1 motion-reduce:transform-none cursor-pointer hover:text-violet-500'>
                    &lt;-
                </span>
            </div>
